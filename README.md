<div align="center">
  <h1 align="center">Hi, I'm Puneeth Raj 👋</h1>
  <p align="center"><b>AI/ML Engineer | Cloud & Infrastructure | Backend Systems</b></p>
  <p align="center"><i>Building robust infra and scalable AI pipelines. Arch Linux enthusiast 🐧</i></p>
  ...
  <p align="center">
    ...
    <a href="https://ep0chzero.github.io/"><img src="https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=google-chrome&logoColor=white" alt="Website" /></a>
  </p>
</div>
...
<div align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=python,fastapi,flask,pytorch,gcp,aws,linux,docker,kubernetes,postgres,mongodb,redis,kafka,rabbitmq,terraform,ansible,jenkins,gitlab,prometheus,grafana&perline=10" />
  </a>
</div>

<br />

Here is a deeper look at the core technologies I work with:

- **Cloud & Infra:** GCP, AWS, Linode, Yotta, Kubernetes, Docker, Proxmox
- **Backend & APIs:** Python, FastAPI, Flask, REST, gRPC, WebSockets
- **AI & LLM Integration:** RAG, PyTorch, TensorRT, LLM Orchestration
- **Data & Messaging:** PostgreSQL, MongoDB, Redis, Kafka, RabbitMQ 
- **CI/CD & Observability:** Terraform, Ansible, GitLab CI, Prometheus, Grafana
